export default function PrivacyPolicy() {
  return (
    <div className="leading-[0] not-italic relative w-full adaptive-margin text-left py-[100px]">
      <div className="font-['Inter'] font-semibold text-[#111111] text-[64px] tracking-[1.28px] mb-[20px]">
        <h1 className="leading-[84px] whitespace-pre">Privacy Policy</h1>
      </div>

      <div className="font-['Inter'] font-medium text-[#111111] text-[20px] tracking-[0.8px] mb-[50px]">
      ...
      <div className="font-['Inter'] font-semibold text-[#111111] text-[38px] tracking-[0.76px] mb-[50px]">
      ...
      <div className="font-['Inter'] font-semibold text-[#111111] text-[38px] tracking-[0.76px] mb-[20px]">
      ...
      <div className="font-['Inter'] font-semibold text-[#111111] text-[24px] tracking-[0.48px] mb-[10px]">
      ...
      <div className="font-['Inter'] font-semibold text-[#111111] text-[24px] tracking-[0.48px] mb-[20px]">
      ...
      <div className="font-['Inter'] font-normal text-[#000000] text-[16px] tracking-[0.64px] mb-[10px]">
        ...
        <ul className="list-disc ml-6 mb-[50px] space-y-2">
          <li className="leading-[24px]">
