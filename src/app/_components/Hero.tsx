  ...
  return (
    <section className="md:max-w-custom mx-4 xl:mx-auto py-16 lg:py-25">
      <div className="flex flex-col xl:flex-row items-center">
        {/* Left Content */}
        <div className="flex-2 flex flex-col justify-between xl:min-h-[585px]">
          <HeroTitle />
          <TrustedBy />
        </div>

        {/* Right Content - Feature Cards */}
        <div className="flex-1 space-y-[30px] py-4 flex flex-col items-start md:items-center xl:items-end w-full">
          <FeatureCard
