...
export const Features = () => {
  return (
    <section className="mx-auto px-4 sm:px-6 py-24 bg-[#FAFAFB] lg:px-[120px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 xl:gap-[75px] justify-items-center">
        <FeatureCard
